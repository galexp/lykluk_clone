...
class VideoPlayerWidget extends StatefulWidget {
  ...
  VideoPlayerWidget(
      this.videoController, this.videoObj, this.initializeVideoPlayerFuture);
  @override
...
class VideoPlayerWidgetState extends StateMVC<VideoPlayerWidget> {
  ...
  void initState() {
   listener = () {
      if (widget.videoController!.value.position.inSeconds == 5 ||
  ...
  checkVideoController() async {
    try {
      ...
      final fileInfo = await CustomCacheManager.instance
          .getFileFromCache(widget.videoObj.url);

      VideoPlayerController controller;
      if (fileInfo == null || fileInfo.file == null) {
        unawaited(CustomCacheManager.instance
            .downloadFile(widget.videoObj.url)
            .whenComplete(
                () => print('saved video url ${widget.videoObj.url}')));
      ...
      videoRepo.homeCon.value.videoControllers[widget.videoObj.url] =
          widget.videoController;

      videoRepo
              .homeCon.value.initializeVideoPlayerFutures[widget.videoObj.url] =
          widget.initializeVideoPlayerFuture;
                    ...
                    Stack(
                      children: <Widget>[
                        Center(
                          child: Container(
                            ...
                            child: SizedBox.expand(
                              child: FittedBox(
                                fit: widget.videoController!.value.size.height >
                        ...
                        Positioned(
                          ...
                          child: Container(
                            height:
                                widget.videoController!.value.size.height * 0.4,
                            width: config.App(scaffoldKey.currentContext)
                                .appWidth(100),
            ...
            return Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    height:
                        config.App(scaffoldKey.currentContext).appHeight(40),
